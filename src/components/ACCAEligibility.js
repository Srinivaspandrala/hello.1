...
const ACCAEligibility = () => {
  return (
    <div>
      <h1 className="section-heading_ACC">ACCA - Eligibility</h1>
              ...
              <Card.Body>
                ...
                <Card.Text>
                  <ul>
                    ...
                    <li>
                      An aggregate of 65% in Mathematics / Accounts and English
                      and a minimum of 50% in other subjects
                    </li>
                    <li>
                      Others can still register for the ACCA course with
