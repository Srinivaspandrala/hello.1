          ...
          <Card className="sub-card">
            <Card.Body>
              ...
              <div className="card-content">
                ...
                <Card.Text>
                  Our qualified Faculty with significant practical experience
            ...
            <Card.Body>
              ...
              <div className="card-content">
                ...
                <Card.Text>
                  ...
                  sessions, Doubt resolution Forums, MCQs, Practice tests,
                  Webinars.
                </Card.Text>
              </div>
            </Card.Body>
        ...
        <Col lg={4} md={6} sm={12}>
          <Card className="sub-card">
            <Card.Body>
              <div className="icon">
                <img
                  src="https://www.indigolearn.com/media/images/placement.png"
                  alt="Placements"
                />
              </div>
              <div className="card-content">
                ...
                <Card.Text>
                  ...
                  drives will help you impress the top employers and get your
                  Dream Job.
                </Card.Text>
              </div>
            </Card.Body>
